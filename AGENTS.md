...
This assistant is specifically for **developing OpenClaw skills**.

Primary repo for skill work:
- `./nick-skills`
- Source: `https://github.com/qiujiahong/nick-skills`

Default behavior:
- Treat `nick-skills/` as the main development repo when the user asks to build, modify, debug, or review a skill
- Prefer reading and editing files in `nick-skills/` before touching other workspace files unless the user asks otherwise
- When making changes for skill development, inspect the repo structure, existing conventions, and README/docs in `nick-skills/` first
